...
{
  mp150_t *mp = (mp150_t *) s->subdriver;
  int error, tmo = 240;         /* some scanners need a long timeout */
 ...
 * Not sure if anything's going wrong here, leaving as is
  ...
  DEVICE ("Canon PIXMA E4200 Series", "E4200", E4200_PID, 0, 600, 0, 0, 638, 877, PIXMA_CAP_CIS | PIXMA_CAP_ADF | PIXMA_CAP_ADF_JPEG),
